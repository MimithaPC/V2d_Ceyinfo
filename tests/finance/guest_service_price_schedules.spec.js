...
//     await page1.waitForTimeout(2000);
//     await page1.getByRole('button', { name: 'Finance Financial reports &' }).click();
//     await page1.getByRole('button', { name: 'Extras' }).click();
//     await page1.getByRole('link', { name: 'Guest Service Prices' }).click();
//     await page1.getByRole('button', { name: 'Close Sidebar' }).click();

//     // Add first Price Schedule

//     await page1.getByRole('button', { name: 'Add Price Schedule' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).fill('Basic Guest Services');
//     await page1.locator('input[name="guestservicespricescheduleheader.from_date"]').fill('2026-06-01');
//     await page1.locator('input[name="guestservicespricescheduleheader.to_date"]').fill('2027-01-27');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.getByRole('combobox', { name: 'Guest Service' }).click();
//     await page1.getByLabel('Laundry Service').getByText('Laundry Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).fill('1200');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Room Service').getByText('Room Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).fill('1500');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Taxi Service').getByText('Taxi Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).fill('5000');
...
//     await page1.getByRole('button', { name: 'Add Price Schedule' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).fill('Comfort Package');
//     await page1.locator('input[name="guestservicespricescheduleheader.from_date"]').fill('2026-06-01');
//     await page1.locator('input[name="guestservicespricescheduleheader.to_date"]').fill('2027-01-27');
...
//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Extra Bed Service').getByText('Extra Bed Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).fill('6000');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Mini Bar Service').getByText('Mini Bar Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).fill('3500');
...
//     await page1.getByRole('button', { name: 'Add Price Schedule' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).fill('Business Traveler Package');
//     await page1.locator('input[name="guestservicespricescheduleheader.from_date"]').fill('2026-06-01');
//     await page1.locator('input[name="guestservicespricescheduleheader.to_date"]').fill('2027-01-27');
    
//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.getByRole('combobox', { name: 'Guest Service' }).click();
//     await page1.getByLabel('Airport Transfer').getByText('Airport Transfer').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).fill('12000');
...
//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Ironing Service').getByText('Ironing Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).fill('600');
...
//     await page1.getByRole('button', { name: 'Add Price Schedule' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).fill('Family Stay Package');
//     await page1.locator('input[name="guestservicespricescheduleheader.from_date"]').fill('2026-06-01');
//     await page1.locator('input[name="guestservicespricescheduleheader.to_date"]').fill('2027-01-27');
 
//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.getByRole('combobox', { name: 'Guest Service' }).click();
//     await page1.getByLabel('Packed Meal Service').getByText('Packed Meal Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).fill('2500');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Taxi Service').getByText('Taxi Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).fill('5000');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Pet Care Service').getByText('Pet Care Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(2).fill('4000');
...
//     await page1.getByRole('button', { name: 'Add Price Schedule' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).click();
//     await page1.getByRole('textbox', { name: 'Schedule Name' }).fill('Premium Guest Services');
//     await page1.locator('input[name="guestservicespricescheduleheader.from_date"]').fill('2026-06-01');
//     await page1.locator('input[name="guestservicespricescheduleheader.to_date"]').fill('2027-01-27');
 
//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.getByRole('combobox', { name: 'Guest Service' }).click();
//     await page1.getByLabel('Spa Service').getByText('Spa Service').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).fill('10000');

//     await page1.getByRole('button', { name: 'Add Service' }).click();
//     await page1.locator('button').filter({ hasText: 'Select a service...' }).click();
//     await page1.getByLabel('Airport Transfer').getByText('Airport Transfer').click();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).dblclick();
//     await page1.getByRole('spinbutton', { name: 'Price' }).nth(1).fill('12000');
