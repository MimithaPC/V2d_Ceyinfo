...
test('test', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Enter NIC' }).fill('0056985966'); //Change
    ...
    await page.getByRole('textbox', { name: 'Enter NIC' }).click();
    await page.getByRole('textbox', { name: 'Enter NIC' }).fill('2911254527'); //Change
    await page.getByRole('combobox', { name: 'Designation *' }).click();
    await page.getByLabel('Receptionist').getByText('Receptionist').click();
    await page.getByRole('combobox', { name: 'Department *' }).click();
    await page.getByLabel('Front Office').getByText('Front Office').click();
    ...
    await page.getByRole('textbox', { name: 'Enter NIC' }).click();
    await page.getByRole('textbox', { name: 'Enter NIC' }).fill('0927899317'); //Change
    await page.getByRole('combobox', { name: 'Designation *' }).click();
    await page.getByLabel('Receptionist').getByText('Receptionist').click();
    await page.getByRole('combobox', { name: 'Department *' }).click();
    await page.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('0054856966'); //Change
    ...
    // await page1.getByRole('textbox', { name: 'Enter mobile' }).fill('0669654368');
    ...
    // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('2918523527'); //Change
    // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // await page1.getByRole('textbox', { name: 'Enter mobile' }).click();
    // await page1.getByRole('textbox', { name: 'Enter mobile' }).fill('0978456345');
    // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // await page1.getByRole('textbox', { name: 'Enter address' }).fill('Alawwa');
    // await page1.getByRole('combobox', { name: 'Province *' }).click();
    // await page1.getByLabel('North Western Province', { exact: true }).getByText('North Western Province').click();
    ...
    // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('0927125317'); //Change
    // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('20079372453'); //Change
    // // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // // await page1.getByRole('button', { name: 'Add New' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).fill('Amna');
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).fill('Suhaib');
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('2896365475'); //Change
    // // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // // await page1.getByPlaceholder('Enter salary').fill('75000');
    // // await page1.getByRole('textbox', { name: 'Enter email' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter email' }).fill('amnaf3479@gmail.com');
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).fill('0758963254');
    // // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter address' }).fill('kurunegala');
    // // await page1.getByRole('combobox', { name: 'Province *' }).click();
    // // await page1.getByLabel('North Western Province', { exact: true }).getByText('North Western Province').click();
    // // await page1.getByRole('combobox', { name: 'City *' }).click();
    // // await page1.getByLabel('Kurunegala').getByText('Kurunegala').click();
    ...
    // // await page1.getByRole('button', { name: 'Add New' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).fill('Chrishantha');
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).fill('Costa');
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('7856321456'); //Change
    // // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // // await page1.getByPlaceholder('Enter salary').fill('75000');
    // // await page1.getByRole('textbox', { name: 'Enter email' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter email' }).fill('chrishanthacosta@gmail.com');
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).fill('0763258945');
    // // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter address' }).fill('kurunegala');
    // // await page1.getByRole('combobox', { name: 'Province *' }).click();
    ...
    // // await page1.getByRole('button', { name: 'Add New' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter first name' }).fill('Kasun');
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter last name' }).fill('Kasun');
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter NIC' }).fill('2001458963'); //Change
    // // await page1.getByRole('combobox', { name: 'Designation *' }).click();
    // // await page1.getByLabel('Receptionist').getByText('Receptionist').click();
    // // await page1.getByRole('combobox', { name: 'Department *' }).click();
    // // await page1.getByLabel('Front Office').getByText('Front Office').click();
    ...
    // // await page1.getByPlaceholder('Enter salary').fill('75000');
    // // await page1.getByRole('textbox', { name: 'Enter email' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter email' }).fill('kasund564@gmail.com');
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter mobile' }).fill('0786325948');
    // // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter address' }).click();
    // // await page1.getByRole('textbox', { name: 'Enter address' }).fill('kurunegala');
    // // await page1.getByRole('combobox', { name: 'Province *' }).click();
