...
//     await page1.getByRole('link', { name: 'Room Class' }).click();
//     await page1.getByRole('button', { name: 'Close Sidebar' }).click();

//     // ----- Add first room class -----

//     await page1.getByRole('button', { name: 'Add Room Class' }).click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Type' }).click();
//     await page1.getByLabel('Single').getByText('Single').click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Category' }).click();
//     await page1.getByLabel('Standard').getByText('Standard').click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).fill('1');
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).click();
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).fill('0');
//     await page1.getByRole('button', { name: 'Select Beds' }).click();
//     await page1.getByRole('button', { name: 'Select' }).nth(1).click();
//     await page1.locator('[id=":rv:-form-item"] > div:nth-child(2) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('.w-5.h-5.flex').first().click();
//     await page1.locator('div:nth-child(4) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('div:nth-child(7) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.getByRole('button', { name: 'Submit Room Class' }).click();
//     await page1.waitForTimeout(2000);
...
//     await page1.getByRole('button', { name: 'Add Room Class' }).click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Type' }).click();
//     await page1.getByLabel('Room Type').getByText('Double', { exact: true }).click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Category' }).click();
//     await page1.getByRole('option', { name: 'Deluxe' }).click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).fill('2');
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).click();
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).fill('0');
//     await page1.getByRole('button', { name: 'Select Beds' }).click();
//     await page1.getByRole('button', { name: 'Select' }).nth(4).click();
//     await page1.locator('div:nth-child(7) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('div').filter({ hasText: /^Safety deposit box$/ }).first().click();
//     await page1.locator('.w-5.h-5.flex').first().click();
//     await page1.locator('div').filter({ hasText: /^AC$/ }).first().click();
//     await page1.locator('div:nth-child(5) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.getByRole('button', { name: 'Submit Room Class' }).click();
//     await page1.waitForTimeout(2000);
...
//     await page1.getByRole('button', { name: 'Add Room Class' }).click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Type' }).click();
//     await page1.getByRole('option', { name: 'Twin', exact: true }).click();
//     await page1.getByRole('combobox').filter({ hasText: 'Select a Room Category' }).click();
//     await page1.getByLabel('Executive').getByText('Executive').click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).click();
//     await page1.getByRole('spinbutton', { name: 'Adult Count *' }).fill('2');
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).click();
//     await page1.getByRole('spinbutton', { name: 'Child Count' }).fill('1');
//     await page1.getByRole('button', { name: 'Select Beds' }).click();
//     await page1.getByRole('button', { name: 'Select' }).nth(4).click();
//     await page1.locator('div:nth-child(7) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('div:nth-child(3) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('div:nth-child(4) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('[id=":r4r:-form-item"] > div:nth-child(2) > .flex.items-center.gap-3 > .w-5').click();
//     await page1.locator('.w-5.h-5.flex').first().click();
//     await page1.getByRole('button', { name: 'Submit Room Class' }).click();
//     await page1.waitForTimeout(2000);
