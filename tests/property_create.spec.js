...
test('test', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Property Name *' }).fill('abc'); //Change
    await page.getByRole('textbox', { name: 'Email *' }).click();
    await page.getByRole('textbox', { name: 'Email *' }).fill('mimitha@gmail.com'); //Change
    await page.getByRole('textbox', { name: 'Mobile *' }).click();
    await page.getByRole('textbox', { name: 'Mobile *' }).fill('0764912257'); //Change
